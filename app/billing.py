...
PLANS: dict[str, Plan] = {
    "developer": Plan(
        "developer", "Developer", "Protocol adoption and local verification.", 0, None,
        3, 100, ("Protocol v1", "CLI", "Trust Passport verification", "3 registered assets"),
    ),
    "growth": Plan(
        "growth", "Growth", "Continuous assurance for production AI systems.", 2499, "STRIPE_PRICE_GROWTH",
        50, 10000, ("50 assets", "Continuous assurance", "Policy enforcement", "Dependency graph", "Audit history"),
    ),
    "enterprise": Plan(
        "enterprise", "Enterprise", "Assurance infrastructure across business-critical AI estates.", None, "STRIPE_PRICE_ENTERPRISE",
        None, None, ("Unlimited assets", "Runtime enforcement", "SSO / private networking", "SLA", "Dedicated support"),
    ),
}
...
class StripeBilling:
    def __init__(self, store: BillingStore):
        ...
        self.success_url = os.getenv("STRIPE_SUCCESS_URL", "https://example.com/console?billing=success")
